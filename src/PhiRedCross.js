      ...
      <div className="Content">
       ...
       <div className='Hospital-set1'>
          <div className='hospital1-group-set1'>
              <img className='hospi1-image-set1' alt='Hospi1' src='RedCross.png' />
          </div>
          ...
          <div className="overlap-hospi-set1">
              <div className="overlap-wrapper-hospi-set1">
                <div className="subnational-blood-wrapper-hospi-set1">
                  ...
                  <p className="redcross-hospi-set1">
          ...
          <div className='infos-hospi-set1' >
            ...
            <div className='redcross-info-set1'>8V6R+XQ5, Osmeña Blvd, Cebu City, 6000 Cebu</div>
            ...
            <div className='hours'>
            <div className='hour-info1-set1'> Closes 12 AM</div>
            <div className='hour-info2-set1'> Closes 12 AM</div>
            <div className='hour-info3-set1'> Closes 12 AM</div>
            <div className='hour-info4-set1'> Closes 12 AM</div>
            <div className='hour-info5-set1'> Closes 12 AM</div>
            <div className='hour-info6-set1'> Closes 12 AM</div>
            <div className='hour-info7-set1'> Closes 12 AM</div>
            </div>

            <div className='phone-set1'> Phone : </div>
            <div className='phone'>
            <div className='phone-info1-set1'>(032) 328 9238</div>
            </div>

            <div className='map-set1'> Location Map : </div>
            <div className='ma-group-set1'>
              <img className='map-image' alt='Map' src='RcMap.png' />
            </div>
