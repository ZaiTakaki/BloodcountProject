...
const ChongHuaHospitalInformation = () => {
...
<div style={{ position: 'relative', marginLeft: '10%', marginTop: '-10%' }}>
  ...
  return (
    ...
    />
    <div
      className="Chong Hua Hospital Mandaue"
      style={{
        color: 'white',
        fontSize: 14,
        fontFamily: 'Poppins',
  ...
  <div className="Address" style={{ marginLeft: '-70%', marginTop: 10 }}>
    ...
    <span style={{ color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}> Mantawe Ave, Tipolo, Mandaue City, 6014 Cebu</span>
  </div>
  {/* Hours */}
{/* Hours */}
...
<div className="Phone09222152471" style={{ marginLeft: '-80%', marginTop: 10 }}>
  ...
  <span style={{ color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '400', textDecoration: 'underline', wordWrap: 'break-word' }}>+63 (32) 233-8000</span>
</div>
...
<button
  ...
  onClick={() => {
    ...
    window.location.href = 'https://www.google.com/maps/dir//chong+hua+hospital+mandaue+address/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x33a999a807abed51:0x8cf1e70e847da08?sa=X&ved=2ahUKEwiXj7n-kuWCAxWXwzgGHSkkALgQ9Rd6BAhKEAA';
  }}
>
  {/* Proceed */}
  <div
...
export default ChongHuaHospitalInformation;
