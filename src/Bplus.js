    ...
    return (
      <div className='blood-type-choices-ad'>
        <div className='blood-line1-ad'>
            ...
            <Button variant="outlined" onClick={() => navigate("/Bplus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530', marginRight: 30, backgroundColor: '#ef1212' }}>B+</Button>
        ...
        <div className='box-pink-ad'>
          <div className='box-pink-set1-ad'> B+ Blood Type Donors</div>
            <div className='box1-pink-ad'>
              <div className='box1-pink-set1-ad'> Kid Doesn't</div>
          ...
          <div className='box2-pink-ad'>
            <div className='box1-pink-set1-ad'> Kobe Lee</div>
          ...
          <div className='box3-pink-ad'>
            <div className='box1-pink-set1-ad'> Martin Legania</div>
          ...
          <div className='box4-pink-ad'>
            <div className='box1-pink-set1-ad'> Carlo Moore</div>
