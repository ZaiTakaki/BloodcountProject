    ...
    return (
      <div className='blood-type-choices-ad'>
        <div className='blood-line1-ad'>
            ...
            <Button variant="outlined" onClick={() => navigate("/ABplus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530',marginRight: 30, backgroundColor: '#ef1212'  }}>AB+</Button>
    ...
    <div className="App">
      ...
      <div className="Content">
        ...
        <div className='box-pink-ad'>
          <div className='box-pink-set1-ad'> AB+ Blood Type Donors</div>
            <div className='box1-pink-ad'>
              <div className='box1-pink-set1-ad'> Gilbert Arena</div>
          ...
          <div className='box2-pink-ad'>
            <div className='box1-pink-set1-ad'> Mark Villa</div>
          ...
          <div className='box3-pink-ad'>
            <div className='box1-pink-set1-ad'> Jovannie Hen</div>
