    ...
    return (
      <div className='blood-type-choices-ad'>
        ...
        <div className='blood-line2-ad'>
            ...
            <Button variant="outlined" onClick={() => navigate("/Ominus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530',backgroundColor: '#ef1212'  }}>O-</Button>
        </div>
