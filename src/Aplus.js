    ...
    return (
      <div className='blood-type-choices-ad'>
        <div className='blood-line1-ad'>
            <Button variant="outlined" onClick={() => navigate("/Aplus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530', marginRight: 30, backgroundColor: '#ef1212' }}>A+</Button>
