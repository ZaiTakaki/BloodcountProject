...
const VSMMCHospitalInformation = () => {
...
<div style={{ position: 'relative', marginLeft: '10%', marginTop: '-10%' }}>
  ...
  return (
    <div className="App">
      ...
      src={rectangle12}
      alt="Vincente Sotto Memorial Medical Center (VSMMC)"
      style={{
        width: 550,
        height: 140,
  ...
  <div className="Address" style={{ marginLeft: '-70%', marginTop: 10 }}>
    <span style={{ color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '700', wordWrap: 'break-word' }}>Address: </span>
    <span style={{ color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>B. Rodriguez St, Cebu City, 6000 Cebu</span>
  </div>
  {/* Hours */}
{/* Hours */}
...
<div className="Phone09222152471" style={{ marginLeft: '-80%', marginTop: 10 }}>
  ...
  <span style={{ color: 'black', fontSize: 16, fontFamily: 'Inter', fontWeight: '400', textDecoration: 'underline', wordWrap: 'break-word' }}>(032) 253 98911</span>
</div>
...
<button
  ...
  onClick={() => {
    ...
    window.location.href = 'https://www.google.com/maps?s=web&client=opera-gx&lqi=Cg52c21tYyBsb2NhdGlvbkja7clWWhEQABgAIgV2c21tYyoECAIQAJIBE2dvdmVybm1lbnRfaG9zcGl0YWyaASRDaGREU1VoTk1HOW5TMFZKUTBGblNVTnhPV0ZUWXpGQlJSQUKqAS4QATIfEAEiG4-uM-iXuCNt_LzS1oVa5dsVWktvzr6YPkPEEDIJEAIiBXZzbW1j&vet=12ahUKEwjhjtjGlOWCAxUGhGMGHV5sC3YQ1YkKegQIDhAB..i&cs=1&um=1&ie=UTF-8&fb=1&gl=ph&sa=X&geocode=KeNDHgJOmakzMW6pPWVZqnqB&daddr=B.+Rodriguez+St,+Cebu+City,+6000+Cebu';
  }}
>
  {/* Proceed */}
  <div
...
export default VSMMCHospitalInformation;
