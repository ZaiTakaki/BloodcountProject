    ...
    return (
      <div className='blood-type-choices-ad'>
        ...
        <div className='blood-line2-ad'>
            ...
            <Button variant="outlined" onClick={() => navigate("/Bminus")} style={{ color: '#ef1212', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530', marginRight: 40 }}>B-</Button>
        ...
        <div className='blood-line3-ad'>
            <Button variant="outlined" onClick={() => navigate("/AvailableDonor")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530', marginRight: 35, backgroundColor: '#ef1212' }}>Show All</Button>
        </div>
      </div>
    );
  };
    ...
    <div className="App">
      ...
      <div className="Content">
        ...
        <div className='box-pink-ad'>
          <div className='box-pink-set1-ad'> All Blood Type Donors</div>
            <div className='box1-pink-ad'>
              ...
              <div className='blood-type-ad'>
                  <span style={{ color: '#ffffff', fontSize: 20, fontFamily: 'sans-serif', fontWeight: '700', letterSpacing: 1, wordWrap: 'break-word' }}>A+</span>
              </div>
           </div>
            </div>
          ...
          <div className='box3-pink-ad'>
            ...
            <div className='bloodtype-boxes-ad'>
              <div className='blood-type-ad'>
                  <span style={{ color: '#ffffff', fontSize: 20, fontFamily: 'sans-serif', fontWeight: '700', letterSpacing: 1, wordWrap: 'break-word' }}>AB+</span>
              </div>
           </div>
          </div>
          ...
          <div className='box4-pink-ad'>
            ...
            <div className='bloodtype-boxes-ad'>
              <div className='blood-type-ad'>
                  <span style={{ color: '#ffffff', fontSize: 20, fontFamily: 'sans-serif', fontWeight: '700', letterSpacing: 1, wordWrap: 'break-word' }}>O-</span>
              </div>
           </div>
          </div>
