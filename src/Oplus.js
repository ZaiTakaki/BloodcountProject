    ...
    return (
      <div className='blood-type-choices-ad'>
        <div className='blood-line1-ad'>
            ...
            <Button variant="outlined" onClick={() => navigate("/Oplus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530',  backgroundColor: '#ef1212'  }}>O+</Button>
        </div>
    ...
    <div className="App">
      ...
      <div className="Content">
        ...
        <div className='box-pink-ad'>
          <div className='box-pink-set1-ad'> O+ Blood Type Donors</div>
            <div className='box1-pink-ad'>
              <div className='box1-pink-set1-ad'> Mike New</div>
          ...
          <div className='box3-pink-ad'>
            <div className='box1-pink-set1-ad'> Jane Davis</div>
          ...
          <div className='box4-pink-ad'>
            <div className='box1-pink-set1-ad'> Lebron James</div>
