    ...
    return (
      <div className='blood-type-choices-ad'>
        ...
        <div className='blood-line2-ad'>
            <Button variant="outlined" onClick={() => navigate("/Aminus")} style={{ color: '#ffffff', fontSize: 28, fontFamily: 'Poppins', fontWeight: '800', textTransform: 'capitalize', letterSpacing: 0.90, wordWrap: 'break-word', borderRadius: '10px', border: '2px solid #861530', marginRight: 35,backgroundColor: '#ef1212' }}>A-</Button>
    ...
    <div className="App">
      ...
      <div className="Content">
        ...
        <div className='box-pink-ad'>
          <div className='box-pink-set1-ad'> A- Blood Type Donors</div>
            <div className='box1-pink-ad'>
              <div className='box1-pink-set1-ad'> Ivan Quezon</div>
          ...
          <div className='box2-pink-ad'>
            <div className='box1-pink-set1-ad'> Palito Cruz</div>
          ...
          <div className='box3-pink-ad'>
            <div className='box1-pink-set1-ad'> Dolphy Human</div>
